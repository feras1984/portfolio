...
const SocialLinkUpdate: React.FC<{category: string, menus: Menu [], menu: Menu}> = (
    {category, menus, menu}
) => {
    ...
    const [linkType, setLinkType] = React.useState<SocialMenuEnum>(selectedMenu.type as SocialMenuEnum);
