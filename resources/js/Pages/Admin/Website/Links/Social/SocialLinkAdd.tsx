...
const SocialLinkAdd: React.FC<{category: string, menus: Menu []}> = ({category, menus}) => {
    ...
    const [linkType, setLinkType] = React.useState<SocialMenuEnum>(SocialMenuEnum.SOCIAL);
    const [file, setFile] = React.useState<File | null>(null);

    const linkTypes: SelectItemsProps [] = Object.values(SocialMenuEnum).map(type => {
        return {
            id: type,
            name: type,
        }
    ...
    const menuSchema = z.object({
        ...
        menuType: z.object({
            ...
            return (type === SocialMenuEnum.SOCIAL && commonService.validateURL(url) ||
            type === SocialMenuEnum.LIST)
        }, {
    ...
    const linkTypeChanged = (event: SelectChangeEvent<unknown>, child?: ReactNode) => {
        setLinkType(event.target.value as SocialMenuEnum);
    }
        ...
        <Box>
            ...
            <FormProvider {...methods}>
                ...
                >
                    ...
                    {linkType === SocialMenuEnum.SOCIAL &&
                    <Box>
                        <ValidatedInput
                            name="url"
                            id="url"
