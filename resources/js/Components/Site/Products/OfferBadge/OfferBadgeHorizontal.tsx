...
const OfferBadgeHorizontal: React.FC<{offer: Offer}> = ({offer}) => {
    ...
    return (
        <div className={styles.badgeOverlay}>
            ...
            <span className={`${styles.topFull} ${styles.badge} ${styles.red} ${styles.spanNoWrap}`}>
...
export default OfferBadgeHorizontal;
